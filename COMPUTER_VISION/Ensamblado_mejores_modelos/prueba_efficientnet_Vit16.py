...
VIT_MODEL_PATH = r"C:\Users\jakif\CODE\PROYECTO-FINAL\COMPUTER_VISION\vision_transformers\best_vit_model_2.pth"
...
def create_vit_classifier(num_classes=2, dropout_rate=0.2):
    # Use vit_large_patch16_224 instead of vit_base_patch16_224
    model = timm.create_model('vit_large_patch16_224', pretrained=True, drop_rate=dropout_rate)
    
    # Modify the classification layer for binary classification with dropout
